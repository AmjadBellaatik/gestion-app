...
@section('page-title', ($document->documentType?->name ?? __('messages.invoice')) . ' — ' . $document->document_number)
...
@php $purchaseOrderNumber = data_get($document->metadata, 'purchase_order_number'); @endphp
@if($purchaseOrderNumber)
    <div class="mt-4 flex items-center gap-2 rounded-xl border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-800">
        <span class="font-semibold">{{ __('messages.purchase_order') }}:</span>
